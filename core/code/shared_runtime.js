...
export const MAX_SYMBOLS = 1000;
export const MAX_DEPENDENCIES = 500;

export const CODE_SYMBOL = z.object({
  kind: z.string(),
  name: z.string(),
...
export const CODE_SYMBOLS_OUTPUT = z.object({
  path: z.string(),
  language: z.string(),
...
export const CODE_GRAPH_NODE = z.object({
  path: z.string(),
  language: z.string(),
...
export const CODE_GRAPH_EDGE = z.object({
  from: z.string(),
  to: z.string(),
  source: z.string(),
  line: z.number().int().positive(),
...
export const CODE_GRAPH_UNRESOLVED = z.object({
  from: z.string(),
  source: z.string(),
  line: z.number().int().positive(),
...
export const CODE_DEPENDENCIES_OUTPUT = z.object({
  path: z.string(),
  recursive: z.boolean(),
...
export const CODE_AUDIT_DEGREE = z.object({
  path: z.string(),
  degree: z.number().int().nonnegative(),
}).strict();

export const CODE_AUDIT_OUTPUT = z.object({
  path: z.string(),
  recursive: z.boolean(),
  max_files: z.number().int().positive(),
  summary: z.object({
...
export const CODE_IMPACT_ITEM = z.object({
  path: z.string(),
...
export const CODE_IMPACT_OUTPUT = z.object({
  scope: z.string(),
...
export async function buildDependencyGraph(requestedPath, recursive, maxFiles) {
...
export function auditGraph(graph, topN) {
...
export function impactGraph(graph, target, direction, maxDepth) {
