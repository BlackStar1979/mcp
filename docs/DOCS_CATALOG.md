...
| `OPERATIONS_DEPLOY.md` | checklist deploy i runtime verification dla zmian runtime | 2026-05-03/05 | `current_reference` | czytać przed deploy/rollback |
| `ROADMAP_REGISTRY_EXECUTION.md` | roadmap registry, web_tools, dispatch i execution; zawiera aktualizację V7.1/V7.2, kolejkę prac, tooling track i rejestr ryzyk architektonicznych | 2026-05-03/04/05 | `current_plan` | czytać przed zmianą kierunku architektury lub pracą nad execution |
